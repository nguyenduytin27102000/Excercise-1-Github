...
<body>
    ...
    $sql = "Select *
		      from nhanvien 
               where CONCAT(Ho,' ',Ten) like '%$tenNV%' ";
    ...
    function printDataPage($data, $pageRecent, $numRowPerPage)
    {
        ...
        if ($numRows > 0) {
            ...
            for ($i = 1; $i <= $numRowPerPage; $i++) {
                ...
                for ($j = 0; $j < $numFields; $j++) {
                    // in ra ảnh của nv, 6 là vị trí cột của ảnh
                    // vì ghép chuỗi ko được nên gắn nó vào biến luôn 
                    $dt = $data[$index][$j];
                    if ($j == 6)
                        echo "<td class='align-middle'> <img src='image/$dt' alt='Ảnh NV'> </td>";
                    else
                ...
                echo "<a href='SuaNV.php?maNV=$msnv' alt='Sửa NV'><button class='btn' style='background-color: pink;'>Sửa</button> </a>";
                echo  "</td>";
                echo "<td class='align-middle'>";
                echo "<a href='XoaNV.php?maNV=$msnv' alt='Xóa NV'><button class='btn' style='background-color: pink;'>Xóa</button> </a>";
                echo  "</td>";
        ...
        <form action="" class="was-validated" method="POST">
            ...
            <div class="form-group row">
                <div class="col-sm-3 col-form-label font-weight-bold ">
                    <label for="tenNV" class="mr-sm-2">Nhập Tên nhân viên:</label>
                </div>
                <div class="col-sm-8 text-left ">
                    <input type="text" class="form-control" id="tenNV" placeholder="Nhập Tên nhân viên" name="tenNV" required value="<?php echo $tenNV; ?>">
    ...
    <div class="container container-sm">
        <table class="table table-striped text-center table-bordered table-hover">
            ...
            <thead>
                <tr>
                    <th colspan="10" style="color:red" class='align-middle'>
                        <h4>BẢNG KẾT QUẢ TÌM KIẾM NHÂN VIÊN</h4>
                    </th>
                </tr>
                <tr>
                    <th class='align-middle'>Mã nhân viên</th>
                    <th class='align-middle'>Họ</th>
                    ...
                    <th class='align-middle'>Mã loại NV</th>
                    <th class='align-middle'>Mã phòng</th>
