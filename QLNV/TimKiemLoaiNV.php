...
<body>
    ...
    $sql = "Select *
		      from loainv
              where TenLoaiNV like '%$tenLoaiNV%' ";
        ...
        <form action="" class="was-validated" method="POST">
            ...
            <div class="form-group row ">
                ...
                <div class="col-sm-12 text-center">
                    <h3>TÌM KIẾM LOẠI NHÂN VIÊN</h3>
                </div>
            </div>
            <!-- row nhập n -->
            <div class="form-group row">
                <div class="col-sm-3 col-form-label font-weight-bold ">
                    <label for="tenLoaiNV" class="mr-sm-2">Nhập Tên loại nhân viên:</label>
                </div>
            ...
            <thead>
                <tr>
                    <th colspan="9" style="color:red" class='align-middle'>
                        <h4>BẢNG KẾT QUẢ TÌM KIẾM LOẠI NHÂN VIÊN</h4>
                    </th>
                </tr>
                <tr>
