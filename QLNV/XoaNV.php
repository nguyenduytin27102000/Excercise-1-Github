    ...
    <div class="container w-75 border text-center">
        ...
        <form action="" class="was-validated" method="POST" id="form1" <?php if ($oke == false) echo 'hidden';
            ...
            <div class="form-group row text-center">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="ho" placeholder="Nhập họ nhân viên:" name="ho" required value="<?php echo $ho  ?>" readonly>
                    <div class="valid-feedback col-sm">Hợp lệ</div>
                    <div class="invalid-feedback col-sm">Vui lòng nhập giá trị hợp lệ</div>
                </div>
            </div>
            ...
            <div class="form-group row text-center">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="ten" placeholder="Nhập tên nhân viên:" name="ten" required value="<?php echo $ten  ?>" readonly>
                    <div class="valid-feedback col-sm">Hợp lệ</div>
                    <div class="invalid-feedback col-sm">Vui lòng nhập giá trị hợp lệ</div>
                </div>
            </div>
            ...
            <div class="form-group row text-center">
                ...
                <div class="col-sm-7">
                    <input type="date" class="form-control" id="ngaySinh" placeholder="Nhập ngày sinh nhân viên:" name="ngaySinh" required value="<?php echo $ngaySinh ?>" min="1950-01-01" max="2030-12-31" readonly>
                    <div class="valid-feedback col-sm">Hợp lệ</div>
                    <div class="invalid-feedback col-sm">Vui lòng nhập giá trị hợp lệ</div>
                </div>
            </div>
                ...
                <div class="col-sm-7 text-left">
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="gioiTinh" value="Nam" <?php if ($gioiTinh == "Nam") echo 'checked'; ?> disabled> Nam
                        </label>
                    </div>
                    <!-- Nữ -->
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="gioiTinh" value="Nữ" <?php if ($gioiTinh == "Nữ") echo 'checked' ?> disabled>Nữ
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row text-center">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="diaChi" placeholder="Nhập địa chỉ nhân viên:" name="diaChi" required value="<?php echo $diaChi  ?>" readonly>
                    <div class="valid-feedback col-sm">Hợp lệ</div>
                    <div class="invalid-feedback col-sm">Vui lòng nhập giá trị hợp lệ</div>
                </div>
            </div>
            <!-- ảnh  tạm thời ghi kiểu text, chưa học upload :3 -->
            <div class="form-group row text-center ">
                <div class="col-sm-5 col-form-label font-weight-bold">
                ...
                <div class="col-sm-7 text-left">
                    <img src="image/<?php echo $anh ?>" alt="ảnh nv">
                </div>
        ...
        <div class="form-group row" <?php if ($oke == false) echo 'hidden' ?>>
            ...
            <div class="col-sm-7">
                <select class="form-control" id="loaiNV" name="maLoaiNV" form="form1" disabled>
        ...
        <div class="form-group row" <?php if ($oke == false) echo 'hidden' ?>>
            <div class="col-sm-5 col-form-label font-weight-bold">
                <label for="phongBan">Mã phòng ban:</label>
            </div>
            <div class="col-sm-7">
                <select class="form-control" id="phongBan" name="phongBan" form="form1" disabled>
                    <?php
